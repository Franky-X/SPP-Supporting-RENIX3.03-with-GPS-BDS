function [obs, nav, doy,Year] = readrinex303(r_o_name,r_n_name,rinex_path)
...
% Read RINEX Observation Files
    [obs.date, obs.epoch, obs.type, obs.station, obs.data, obs.index, obs.rcvpos, obs.time] = readrinexobs303(r_o_name);
...
% Read RINEX Navigation File
    [nav.eph, nav.index, nav.ionprm] = readrinexnav303(r_n_name);
